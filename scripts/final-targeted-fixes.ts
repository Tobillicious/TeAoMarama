...
const __teacherDashboardPath = 'src/pages/TeacherDashboard.tsx'
  if (fs.existsSync(teacherDashboardPath)) {
const __content = fs.readFileSync(teacherDashboardPath, 'utf8')
...
const __newContent4 = newContent3.replace(

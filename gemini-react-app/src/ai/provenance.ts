...
export async function writeEpisode(__type: Episode['type'],   __episode: Partial<Episode>): Promise<void> {
...
export function getEpisodesByType(__type: Episode['type']): Episode[] {
return globalProvenance.getEpisodesByType(type)
}
export function getRecentEpisodes(__count?: number): Episode[] {

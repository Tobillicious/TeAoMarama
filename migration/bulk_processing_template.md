...
**Duration**: [30/45/60/75] minutes
**NZ Curriculum**: [Specific Achievement Objective]

**Cultural Context**: [CULTURAL_SAFETY_FLAG if Māori content present]
**Te Reo Integration**: [CULTURAL_SAFETY_FLAG if te reo used]
**Tikanga Connection**: [CULTURAL_SAFETY_FLAG if tikanga referenced]
```
...
- [Specific learning objective aligned to NZ Curriculum]
...
### [Section 1 Title]
[Content with NZ context where appropriate]
...
### Activity 1: [Name]
**Instructions**: [Clear, age-appropriate instructions]
**Materials**: [List required resources]
...
- **Observation Points**: [Behaviors to observe]
- **Quick Checks**: [Rapid understanding checks]
- **Peer Assessment**: [Student-to-student evaluation]

### Summative Assessment  
- **Success Criteria**: [Aligned to learning objectives]
- **Marking Rubric**: [4-level proficiency scale]
- **Cultural Responsiveness**: [How assessment honors diverse learners]
```
...
- Māori historical content → Sensitivity and accuracy review
...
✅ Cultural Safety: [No harmful stereotypes or misrepresentation]
✅ Educational Value: [Clear learning progression]
✅ Practical Application: [Real-world NZ connections]
```
...
4. Add age-appropriate activities and assessments
...
4. NZ Curriculum alignment verification
...
4. Provenance logging for tracking
...
- **Bicultural Content**: Respectful representation required
...
- ✅ **Student Engagement**: Age-appropriate and relevant content
...
**Subject**: Mathematics  
**Duration**: 60 minutes
**NZ Curriculum**: Mathematics Level 4 - Patterns and Relationships

**Cultural Context**: Uses All Blacks rugby statistics and waka racing data
**Te Reo Integration**: Mathematical terms with te reo translations provided
**Tikanga Connection**: CULTURAL_SAFETY_FLAG - Respect for sporting traditions

## 🎯 Learning Intentions

**WALT** (We Are Learning To):
- Identify and describe linear patterns in real-world data
- Create algebraic expressions to represent patterns

**WALA** (We Are Learning About):
- How mathematics helps us understand sports performance
- The relationship between practice time and improvement

**Success Criteria**:
- [ ] I can identify whether a pattern is linear or non-linear
- [ ] I can write an algebraic rule for a linear pattern  
- [ ] I can use patterns to make predictions about sports performance
```

---

**MIHARA'S CULTURAL SAFETY REMINDER**:
*Ko te mea nui ko te aroha* - Every resource created with love, respect, and cultural consciousness

**KAITIAKI MAHARA - TEMPLATE FOR EXCELLENCE** 📚

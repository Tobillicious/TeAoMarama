# Mathematics Y8 - Proportions in Aotearoa
*Te Kura o TeAoMarama - Mathematics*

**Year Level**: 8
**Subject**: Mathematics  
**Duration**: 30 minutes
**NZ Curriculum**: Number & Algebra
...
- Connect mathematics concepts to real contexts in Aotearoa
- Apply knowledge to solve problems and explain thinking

**WALA** (We Are Learning About):
- Key ideas in Proportions
- Strategies for success in mathematics

**Success Criteria**:
- [ ] I can explain key ideas in Proportions
...
### Context
This resource explores proportions through familiar, local examples across Aotearoa.
...
**Exit Ticket**:
1. What did you learn about proportions today?

...
- I can use statistical reasoning to make informed conclusions about New Zealand society

---

## Rich Text Resource: Data Stories from Aotearoa
...
- **Urban vs Rural**: 86.3% urban, 13.7% rural
...
- **Bay of Plenty**: 56 people/km² (355,200 total population)
...
- **Hamilton**: $725,000 (range: $500,000 - $1,100,000)
- **Tauranga**: $825,000 (range: $600,000 - $1,400,000)
...
- **$1,200-$1,999**: 18.6% of working population
- **$2,000+**: 6.8% of working population
...
4. **Retail Trade**: 9.1% (231,200 people)
5. **Construction**: 8.7% (221,000 people)
6. **Manufacturing**: 8.4% (213,400 people)
7. **Accommodation & Food Services**: 6.9% (175,300 people)
8. **Agriculture, Forestry & Fishing**: 6.1% (155,000 people)
9. **Public Administration & Safety**: 5.8% (147,400 people)
...
- **Not in education or employment**: 12.6%
- **Unemployment rate**: 9.2% (compared to 3.4% national average)
...
- **Dunedin**: Average temp 10.9°C, annual rainfall 812mm
...
- **Carbon emissions**: 82.3 million tonnes CO₂ equivalent (2022)
- **Renewable energy**: 84.2% of electricity generation (2023)
...
- **YouTube**: 89.4% of population 13+
- **LinkedIn**: 28.9% of population 18+
...
Mean = (1,050,000 + 875,000 + 650,000 + 725,000 + 825,000 + 525,000) ÷ 6 = ?
...
- **Predict**: Which regions might need targeted employment programs?
...
**Round 1 - Graph Selection** (15 minutes):
...
**Round 2 - Creating Effective Visualizations** (20 minutes):
...
- 55+ years: 3.1 hours daily usage

**Round 3 - Bias Detection** (15 minutes):
**Task**: Analyze three different representations of the same education qualification data and identify potential bias

**Graph A**: Bar chart starting y-axis at 10% (makes differences look larger)
**Graph B**: Pie chart with 3D effects and tilted perspective
...
**Extension**: Create a "misleading" version and an "honest" version of the youth employment data.
...
**Option A - Housing Affordability Analysis**:
...
**Option B - Educational Outcomes Investigation**:
...
**Option C - Climate Change Impact Assessment**:
...
4. **Findings and conclusions** supported by evidence (4 minutes)
...
- **Communication**: 20% - Clear presentation of findings with appropriate mathematical language
...
- Graphs and visualizations that support conclusions
- Discussion of limitations and potential bias in data
...
- Include interactive elements to engage audience
- Reflection on effective statistical communication
...
- **Database skills**: Understanding how large datasets are organized and queried
...
- **Critical analysis**: Question whose voices are included/excluded in official statistics
...
- **Mathematical reasoning**: Making inferences and drawing conclusions from data
...
- **Royal Statistical Society**: International professional learning resources

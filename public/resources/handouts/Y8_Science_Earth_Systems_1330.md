# Science Y8 - Earth Systems in Aotearoa
*Te Kura o TeAoMarama - Science*

**Year Level**: 8
**Subject**: Science  
**Duration**: 60 minutes
**NZ Curriculum**: Living World
...
- Connect science concepts to real contexts in Aotearoa
- Apply knowledge to solve problems and explain thinking

**WALA** (We Are Learning About):
- Key ideas in Earth Systems
- Strategies for success in science

**Success Criteria**:
- [ ] I can explain key ideas in Earth Systems
...
### Context
This resource explores earth systems through familiar, local examples across Aotearoa.
...
**Exit Ticket**:
1. What did you learn about earth systems today?

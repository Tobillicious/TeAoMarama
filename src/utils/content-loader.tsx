...
export const loadTeKeteAkoContent = async (): Promise<ContentItem[]> => {
  ...
  content.push({
    ...
    description: 'Comprehensive worksheet covering conversions between fractions, decimals, and percentages with practice problems and answer key.',
  ...
  content.push({
    ...
    subject: 'Mathematics',
    yearLevel: 'Years 7-9',
    description: 'Interactive worksheet exploring area and perimeter calculations with real-world applications.',
  ...
  content.push({
    ...
    description: 'Comprehensive worksheet on negative numbers, absolute value, and their applications in real-world contexts.',
  ...
  content.push({
    ...
    subject: 'Mathematics',
    yearLevel: 'Years 7-9',
    description: 'Step-by-step guide to order of operations with practice problems and real-world applications.',
  ...
  content.push({
    ...
    description: 'Comprehensive unit centering Māori perspectives, agency, and resistance in Aotearoa history. Challenges colonial narratives.',
  ...
  content.push({
    ...
    description: 'Exploring current social, political, and cultural issues in Aotearoa with critical analysis frameworks.',
  ...
  content.push({
    ...
    description: 'Comprehensive guide for creating culturally authentic, pedagogically sound lessons with Te Ao Māori integration.',
  ...
  content.push({
    ...
    yearLevel: 'All Levels',
    description: 'Professional design system documentation with color palette, typography, and cultural integration guidelines.',
  ...
  content.push({
    ...
    subject: 'Teaching Resources',
    yearLevel: 'All Levels',
    description: 'Comprehensive checklist for ensuring cultural safety in educational materials and practices.',
  ...
  content.push({
    ...
    subject: 'Teaching Resources',
    yearLevel: 'All Levels',
    description: 'Professional lesson plan template with cultural integration, learning objectives, and assessment criteria.',
  ...
  content.push({
    ...
    subject: 'Teaching Resources',
    yearLevel: 'All Levels',
    description: 'Comprehensive unit plan template with cultural context, learning progressions, and assessment strategies.',
...
export const loadDeepSeekContent = async (): Promise<ContentItem[]> => {
  ...
  content.push({
    ...
    subject: 'Social Studies',
    yearLevel: 'Year 10',
    description: 'Interactive activity exploring traditional Māori economic systems and trade networks.',
  ...
  content.push({
    ...
    subject: 'Mathematics',
    yearLevel: 'Year 9',
    description: 'Assessment activity using real New Zealand census data to explore statistical concepts.',
  ...
  content.push({
    ...
    subject: 'English',
    yearLevel: 'Year 7',
    description: 'Educational handout exploring narrative structure through traditional Māori stories and legends.',
  ...
  content.push({
    ...
    subject: 'Mathematics',
    yearLevel: 'Year 8',
    description: 'Mathematical concepts explored through traditional Māori building and architectural practices.',
  ...
  content.push({
    ...
    subject: 'Science',
    yearLevel: 'Year 9',
    description: 'Science lesson exploring native plant adaptations and their role in Aotearoa ecosystems.',

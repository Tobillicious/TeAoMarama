...
export default function LessonPlan() {const [currentLesson] = useState<LessonPlanData>(sampleLesson)
  const [expandedActivity, setExpandedActivity] = useState<number | null>(null)

const toggleActivity = (_index: number) => {
setExpandedActivity(expandedActivity === index ? null : index)}

return (
_<div className="lesson-plan-container">
      {/* Header */}
      ...
      <section className="objectives-section">
        ...
        <ul className="objectives-list">
          {currentLesson.learningObjectives.map((objective,  _index) => (
      ...
      <section className="curriculum-section">
        ...
        <div className="curriculum-grid">
          <div className="curriculum-block">
            ...
            <ul>
              {currentLesson.curriculumLinks.nzc.map(_(link,  _index) => (
          ...
          <div className="curriculum-block">
            ...
            <ul>
              {currentLesson.curriculumLinks.mataiaho.map(_(link,  _index) => (
                <li key={index}>{link}</li>
              ))}
            </ul>
          </div>
      ...
      <section className="activities-section">
        ...
        <div className="activities-timeline">
          {currentLesson.activities.map(_(activity,  _index) => (
_<div key={index} className="activity-card">
              <div 
...
onClick={() => toggleActivity(index)}
              ...
              {expandedActivity === index && (
                <div className="activity-details">
                  ...
                  <div className="activity-resources">
                    ...
                    <ul>
                      {activity.resources.map(_(resource,  _idx) => (
      ...
      <section className="resources-section">
        ...
        <div className="resources-grid">
          {currentLesson.resources.map(_(resource,  _index) => (
      ...
      <section className="assessment-section">
        ...
        <div className="assessment-grid">
          <div className="assessment-block">
            ...
            <ul>
              {currentLesson.assessment.formative.map(_(item,  _index) => (
          ...
          <div className="assessment-block">
            ...
            <ul>
              {currentLesson.assessment.summative.map(_(item,  _index) => (
                <li key={index}>{item}</li>
              ))}
            </ul>
          </div>
      ...
      <section className="differentiation-section">
        ...
        <ul className="differentiation-list">
          {currentLesson.differentiation.map(_(strategy,  _index) => (

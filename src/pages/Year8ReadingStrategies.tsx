...
export default function Year8ReadingStrategies() {const [selectedStrategy, setSelectedStrategy] = useState<ReadingStrategy | null>(null)
...
const filteredStrategies = readingStrategies.filter(_(strategy) => {
...
const handleAnswerChange = (_questionId: string,  _answer: string) => {
setPracticeAnswers(_(prev) => ({
      ...prev,
      [questionId]: answer,
    }))
  }
      ...
      <section className="reading-framework">
        ...
        <div className="framework-grid">
          <div className="framework-card">
            ...
            <p>
Activate prior knowledge,  _set purposes,  _and make predictions to prepare for successful
reading.
            </p>
            <ul>
          ...
          <div className="framework-card">
            ...
            <p>
Monitor comprehension,  _ask questions,  _and make connections while actively engaging
with text.
            </p>
            <ul>
          ...
          <div className="framework-card">
            <h3>💭 After Reading</h3>
            <p>Synthesize information,  _evaluate understanding,  _and make meaningful connections.</p>
            <ul>
                ...
                <div className="strategy-details">
                  <div className="steps-section">
                    ...
                    <ol className="strategy-steps">
                      {selectedStrategy.steps.map(_(step,  _index) => (
                  ...
                  <div className="strategy-info-grid">
                    <div className="text-types">
                      ...
                      <div className="text-type-tags">
                        {selectedStrategy.textTypes.map(_(type,  _index) => (
...
_<div className="examples-section">
                      <h4>💡 Examples in Practice</h4>
                      <div className="examples-grid">
                        {selectedStrategy.examples.map((example,  _index) => (
          ...
          <section className="strategies-grid-section">
            ...
            <div className="strategies-grid">
              {filteredStrategies.map(_(strategy) => (
_<div
key={strategy.id}
            ...
            <div className="practice-workspace">
              ...
              <div className="vocabulary-focus">
                ...
                <div className="vocab-words">
                  {selectedText.vocabularyFocus.map((word,  _index) => (
              ...
              <div className="comprehension-questions">
                ...
                <div className="question-category">
                  ...
                  {selectedText.comprehensionQuestions.literal.map(_(question,  _index) => (
_<div key={`literal-${index}`} className="question-item">
...
rows={2}
                ...
                <div className="question-category">
                  ...
                  {selectedText.comprehensionQuestions.inferential.map(_(question,  _index) => (
_<div key={`inferential-${index}`} className="question-item">
                      <p className="question">{question}</p>
                      <textarea
className="answer-input"
placeholder="Your answer..."
...
rows={3}
                ...
                <div className="question-category">
                  ...
                  {selectedText.comprehensionQuestions.evaluative.map(_(question,  _index) => (
_<div key={`evaluative-${index}`} className="question-item">
                      <p className="question">{question}</p>
                      <textarea
className="answer-input"
placeholder="Your answer..."

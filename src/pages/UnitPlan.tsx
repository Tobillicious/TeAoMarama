...
export default function UnitPlan() {return (
_<div className="unit-plan-container">
      ...
      <section className="curriculum-links">
        ...
        <div className="curriculum-section">
          ...
          <ul>
            {sampleUnitPlan.curriculumLinks.mataiaho.map((link,  _index) => (
        ...
        <div className="curriculum-section">
          ...
          <ul>
            {sampleUnitPlan.curriculumLinks.nzc.map(_(link,  _index) => (
              <li key={index}>{link}</li>
            ))}
          </ul>
        </div>
        ...
        <div className="curriculum-section">
          ...
          <ul>
            {sampleUnitPlan.curriculumLinks.other.map(_(link,  _index) => (
              <li key={index}>{link}</li>
            ))}
          </ul>
        </div>
      ...
      <section className="lessons-overview">
        ...
        <div className="lessons-grid">
          {sampleUnitPlan.lessons.map(_(lesson) => (
_<div key={lesson.number} className="lesson-card">
              ...
              <div className="objectives">
                ...
                <ul>
                  {lesson.learningObjectives.map((obj,  _index) => (
                    <li key={index}>{obj}</li>
                  ))}
                </ul>
              </div>
              ...
              <div className="activities">
                ...
                <ul>
                  {lesson.activities.map(_(activity,  _index) => (
      ...
      <section className="assessments">
        ...
        <div className="assessments-grid">
          {sampleUnitPlan.assessments.map(_(assessment,  _index) => (
            <div key={index} className={`assessment-card ${assessment.type.toLowerCase().replace(' ', '-')}`}>
              ...
              <div className="criteria">
                ...
                <ul>
                  {assessment.criteria.map(_(criterion,  _idx) => (

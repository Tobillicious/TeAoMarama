    ...
    <div className="structured-literacy-container">
      <div className="hero-section">
        ...
        <p className="hero-subtitle">
          Deep, meaningful learning experiences aligned with the New Zealand Curriculum
        </p>
        ...
        {filteredUnits.map((unit) => (
          <div key={unit.id} className="unit-card" onClick={() => setSelectedUnit(unit)}>
            ...
            <div className="unit-focus">
              ...
              <ul>
                {unit.learningIntentions.slice(0, 2).map((intention, index) => (
        ...
        <div className="unit-detail-modal">
          <div className="modal-content">
            ...
            <div className="curriculum-section">
              ...
              <div className="curriculum-details">
                ...
                <div className="objectives">
                  ...
                  <ul>
                    {selectedUnit.curriculumObjectives.map((obj, index) => (
                      <li key={index}>{obj}</li>
                    ))}
                  </ul>
                </div>
                <div className="achievement-objectives">
                  ...
                  <ul>
                    {selectedUnit.achievementObjectives.map((ao, index) => (
                      <li key={index}>{ao}</li>
                    ))}
                  </ul>
                </div>
            ...
            <div className="learning-section">
              ...
              <div className="learning-details">
                <div className="intentions">
                  ...
                  <ul>
                    {selectedUnit.learningIntentions.map((intention, index) => (
                      <li key={index}>{intention}</li>
                    ))}
                  </ul>
                </div>
                <div className="success-criteria">
                  ...
                  <ul>
                    {selectedUnit.successCriteria.map((criteria, index) => (
            ...
            <div className="assessment-section">
              <h3>Assessment</h3>
              <ul>
                {selectedUnit.assessments.map((assessment, index) => (

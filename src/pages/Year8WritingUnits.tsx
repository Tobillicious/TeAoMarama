...
const Year8WritingUnits: React.FC = () => {
  ...
  return (
    <div className="year8-writing-container">
      ...
      <div className="unit-overview">
        <div className="overview-grid">
          ...
          <div className="overview-card">
            ...
            <ul>
              {year8WritingUnit.learningIntentions.map((intention, index) => (
          ...
          <div className="overview-card">
            ...
            <ul>
              {year8WritingUnit.successCriteria.map((criteria, index) => (
      ...
      <div className="curriculum-section">
        ...
        <div className="curriculum-details">
          <div className="objectives">
            ...
            <ul>
              {year8WritingUnit.curriculumObjectives.map((obj, index) => (
                <li key={index}>{obj}</li>
              ))}
            </ul>
          </div>
          <div className="achievement-objectives">
            ...
            <ul>
              {year8WritingUnit.achievementObjectives.map((ao, index) => (
                <li key={index}>{ao}</li>
              ))}
            </ul>
          </div>
      ...
      <div className="lessons-section">
        ...
        <div className="lessons-grid">
          {year8WritingUnit.lessons.map((lesson) => (
      ...
      <div className="assessment-section">
        ...
        <ul>
          {year8WritingUnit.assessments.map((assessment, index) => (
      ...
      <div className="resources-section">
        <h2>Key Resources</h2>
        <ul>
          {year8WritingUnit.resources.map((resource, index) => (

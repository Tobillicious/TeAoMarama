    ...
    <div className="year8-social-studies-container">
      ...
      <div className="unit-overview">
        <div className="overview-grid">
          ...
          <div className="overview-card">
            ...
            <ul>
              {year8SocialStudiesUnit.learningIntentions.map((intention, index) => (
          ...
          <div className="overview-card">
            ...
            <ul>
              {year8SocialStudiesUnit.successCriteria.map((criteria, index) => (
      ...
      <div className="curriculum-section">
        ...
        <div className="curriculum-details">
          <div className="objectives">
            ...
            <ul>
              {year8SocialStudiesUnit.curriculumObjectives.map((obj, index) => (
                <li key={index}>{obj}</li>
              ))}
            </ul>
          </div>
          <div className="achievement-objectives">
            ...
            <ul>
              {year8SocialStudiesUnit.achievementObjectives.map((ao, index) => (
                <li key={index}>{ao}</li>
              ))}
            </ul>
          </div>
      ...
      <div className="lessons-section">
        ...
        <div className="lessons-grid">
          {year8SocialStudiesUnit.lessons.map((lesson) => (
      ...
      <div className="assessment-section">
        ...
        <ul>
          {year8SocialStudiesUnit.assessments.map((assessment, index) => (
      ...
      <div className="resources-section">
        <h2>Key Resources</h2>
        <ul>
          {year8SocialStudiesUnit.resources.map((resource, index) => (

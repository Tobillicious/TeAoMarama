...
culturalApplication: '🌟 Use Te Reo Māori vocabulary and cultural contexts in sentence expansion exercises. Integrate Māori cultural concepts like whanaungatanga (relationships), manaakitanga (hospitality), and kaitiakitanga (guardianship) to create meaningful, culturally-rich sentences.',,
...
culturalApplication: '🌟 Combine sentences about cultural practices and traditional knowledge. Explore concepts like tikanga (customs), kōrero tuku iho (oral traditions), and pūrākau (stories) to create sophisticated cultural narratives.',,
...
export default function Year8WritingRevolution() {const [selectedActivity, setSelectedActivity] = useState<WritingActivity | null>(null)
...
const filteredActivities = writingActivities.filter(_(activity) => {
...
return (
_<div className="writing-revolution-container">
...
academic success with Te Ao Māori integration
        ...
        <div className="ero-stats">
          <span className="stat">📚 5, _439 Educational Resources</span>
          <span className="stat">🌿 3, _372 Māori Cultural Resources</span>
...
before attempting longer pieces.
          ...
          <div className="philosophy-card">
            ...
            <p>
Build writing skills step-by-step,  _from sentences to paragraphs to complete essays, 
_with explicit instruction.
            </p>
          </div>
          <div className="philosophy-card">
...
skills and critical thinking.
          ...
          <div className="philosophy-card cultural-highlight">
            ...
            <p>
Use meaningful cultural content to practice writing skills,  _honoring students'
backgrounds and knowledge. Integrate 3, _372 Māori cultural resources seamlessly.
            </p>
            <div className="cultural-badge">5, _439 Total Resources • 3, _372 Māori Cultural</div>
          </div>
        </div>
      </section>
                ...
                <div className="activity-details">
                  <div className="steps-section">
                    ...
                    <ol className="activity-steps">
                      {selectedActivity.steps.map(_(step,  _index) => (
                  ...
                  <div className="examples-section">
                    ...
                    <div className="examples-list">
                      {selectedActivity.examples.map(_(example,  _index) => (
                  ...
                  <div className="activity-info-grid">
                    ...
                    <div className="materials-needed">
                      ...
                      <ul>
                        {selectedActivity.materials.map(_(material,  _index) => (
...
_<>
          <section className="patterns-intro">
            ...
            <p>
Master these essential sentence patterns for clear,  _sophisticated academic writing.
            </p>
            ...
            <section className="pattern-showcase">
              <div className={`pattern-spotlight type-${selectedPattern.type}`}>
                ...
                {selectedPattern.signalWords.length > 0 && (
                  <div className="signal-words">
                    ...
                    <div className="signal-words-list">
                      {selectedPattern.signalWords.map((word,  _index) => (
                ...
                <div className="common-mistakes">
                  ...
                  <ul>
                    {selectedPattern.commonMistakes.map(_(mistake,  _index) => (
          ...
          <section className="patterns-grid-section">
            ...
            <div className="patterns-grid">
              {sentencePatterns.map(_(pattern) => (
_<div
key={pattern.id}
...
onClick={() => setSelectedPattern(pattern)}
      ...
      {activeMode === 'practice' && (
_<section className="practice-mode">

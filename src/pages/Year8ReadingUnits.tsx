  ...
  const readingUnits: ReadingUnit[] = [
    {
      ...
      description: 'Explore Māori whakapapa through traditional and contemporary texts, understanding the importance of genealogy and cultural identity.',
      ...
      skills: ['Cultural Reading', 'Identity Analysis', 'Genealogical Understanding', 'Cultural Context']
    },
    {
      id: 'unit-2',
      title: 'Contemporary New Zealand Literature',
      description: 'Analyze contemporary New Zealand texts, exploring themes of identity, belonging, and cultural diversity in modern society.',
      difficulty: 'advanced',
      category: 'fiction',
      duration: '5 weeks',
      activities: 12,
      ...
      skills: ['Contemporary Analysis', 'Identity Exploration', 'Cultural Diversity', 'Modern Themes']
    },
    {
      id: 'unit-3',
      title: 'Pacific Literature and Oral Traditions',
      description: 'Discover Pacific literature and oral storytelling traditions, understanding the rich cultural heritage of Pacific peoples.',
      difficulty: 'intermediate',
      category: 'cultural',
      duration: '4 weeks',
      activities: 10,
      culturalElements: ['Pacific Traditions', 'Oral Storytelling', 'Cultural Heritage', 'Pacific Identity'],
      nceaAlignment: ['Level 1 English 1.5', 'Level 1 English 1.6'],
      skills: ['Oral Traditions', 'Cultural Heritage', 'Pacific Literature', 'Storytelling Analysis']
    },
    {
      id: 'unit-4',
      title: 'Environmental Literature and Sustainability',
      description: 'Read texts about environmental issues and sustainability, exploring our relationship with the natural world.',
      difficulty: 'advanced',
      category: 'non-fiction',
      duration: '5 weeks',
      activities: 13,
      culturalElements: ['Environmental Awareness', 'Sustainability', 'Natural World', 'Cultural Connection'],
      nceaAlignment: ['Level 1 English 1.7', 'Level 1 English 1.8'],
      skills: ['Environmental Literacy', 'Sustainability Analysis', 'Natural World Connection', 'Critical Reading']
    },
    {
      id: 'unit-5',
      title: 'Poetry and Creative Expression',
      description: 'Analyze poetry from diverse cultural perspectives, exploring creative expression and linguistic artistry.',
      difficulty: 'intermediate',
      category: 'poetry',
      duration: '4 weeks',
      activities: 11,
      culturalElements: ['Poetic Expression', 'Cultural Perspectives', 'Linguistic Artistry', 'Creative Writing'],
    ...
    },
    {
      ...
      description: 'Develop skills in reading and analyzing digital texts, multimedia content, and online media.',
      difficulty: 'advanced',
      category: 'non-fiction',
      duration: '6 weeks',
      activities: 15,
      culturalElements: ['Digital Literacy', 'Media Analysis', 'Online Content', 'Digital Citizenship'],
            ...
            {filteredUnits.map((unit) => (
              <div key={unit.id} className="reading-card">
                <div className="reading-header">
                  <span className="reading-badge">{getCategoryIcon(unit.category)} {unit.category}</span>
                  <span 
                ...
                <button className="explore-reading-btn">
                  Explore Unit
                </button>
              </div>
            ))}
        ...
        <div className="container">
          <div className="cultural-content">
            <div className="cultural-item">
              ...
              <p>Develop reading skills that respect and incorporate Māori and Pacific cultural perspectives and worldviews.</p>
            </div>
            <div className="cultural-item">
              <h3>Literary Excellence</h3>
              <p>Master advanced reading comprehension skills for academic success and informed citizenship.</p>
            </div>
            <div className="cultural-item">
              <h3>Cultural Identity</h3>
              <p>Use reading skills to explore cultural identity, belonging, and diversity in Aotearoa New Zealand.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cta-section">
        <div className="container">
          ...
          <p className="cta-description">
            Start developing advanced reading skills that will prepare you 
            for academic success and cultural understanding in a diverse world.
          </p>

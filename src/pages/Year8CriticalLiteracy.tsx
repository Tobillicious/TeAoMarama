  ...
  const criticalSkills: CriticalSkill[] = [
    {
      ...
      description:
        'Develop critical analysis skills to examine texts through Māori and Pacific cultural lenses, understanding multiple perspectives and worldviews.',
    ...
    },
    {
      ...
      description:
        'Master critical evaluation of digital media, traditional texts, and multimedia content for bias, credibility, and cultural representation.',
      difficulty: 'advanced',
      category: 'evaluation',
      duration: '6 weeks',
      activities: 15,
    ...
    },
    {
      ...
      description:
        'Develop skills to analyze arguments, identify logical fallacies, and evaluate evidence across cultural and academic contexts.',
      difficulty: 'intermediate',
      category: 'analysis',
      duration: '4 weeks',
      activities: 10,
    ...
    },
    {
      ...
      description:
        'Learn to synthesize information from multiple sources, connecting ideas across cultural contexts and academic disciplines.',
      difficulty: 'advanced',
      category: 'synthesis',
      duration: '5 weeks',
      activities: 14,
    ...
    },
    {
      ...
      description:
        'Master advanced reading strategies to analyze texts for meaning, purpose, audience, and cultural significance.',
      difficulty: 'intermediate',
      category: 'analysis',
      duration: '4 weeks',
      activities: 11,
    ...
    },
    {
      ...
      description:
        'Develop critical literacy skills to analyze social issues, advocate for justice, and take informed action in communities.',
      difficulty: 'advanced',
      category: 'cultural',
      duration: '6 weeks',
      activities: 13,
              ...
              <div key={skill.id} className="critical-card">
                <div className="critical-header">
                  ...
                  <span
                    ...
                    /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ backgroundColor: getDifficultyColor(skill.difficulty) }}
                  >
                    {skill.difficulty}
                  </span>
                </div>
                ...
                <button className="explore-critical-btn">Explore Skill</button>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container">
          <div className="cultural-content">
            <div className="cultural-item">
              ...
              <p>
                Develop critical literacy skills that respect and incorporate Māori and Pacific
            ...
            <div className="cultural-item">
              ...
              <p>
                Master advanced critical thinking skills for academic success and informed
                decision-making across all subjects.
              </p>
            </div>
            <div className="cultural-item">
              <h3>Social Responsibility</h3>
              <p>
                Use critical literacy skills to analyze social issues, advocate for justice, and
      ...
      <section className="cta-section">
        <div className="container">
          ...
          <p className="cta-description">
            Start developing sophisticated critical thinking skills that will prepare you for
            academic success and informed citizenship in a diverse world.
          </p>

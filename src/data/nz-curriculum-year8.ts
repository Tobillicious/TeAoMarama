    ...
    activities: [
      {
        ...
        description:
          'Students examine original Te Tiriti text alongside English Treaty version, identifying key differences and implications',
        duration: '90 minutes',
        materials: [
      ...
      },
      {
        ...
        description:
          'Students research and present different viewpoints on how Waitangi Day should be commemorated in New Zealand',
    ...
    assessments: [
      {
        ...
        description:
          'Students write a 500-word essay analyzing the ongoing impact of Te Tiriti o Waitangi on contemporary New Zealand society',
        criteria: [
    ...
    resources: [
      {
        ...
        type: 'website',
        description:
          'Official government archives with high-resolution images of original Treaty documents and detailed historical context',
      ...
      },
      {
        ...
        type: 'website',
        description:
          'Side-by-side comparison of the Māori and English versions with detailed analysis of differences',
        source: 'Archives New Zealand',
      },
      {
        ...
        type: 'website',
        description:
          'Contemporary Treaty settlement processes and Tribunal findings on historical and modern Treaty claims',
      ...
      },
      {
        ...
        type: 'interactive',
        description:
          'Interactive online exhibition with artifacts, stories, and multimedia presentations about the Treaty',
    ...
    culturalConnections: [
      {
        ...
        description:
          'Understanding how Māori customs and protocols influenced the Treaty signing process and continue to shape its interpretation',
        ...
        culturalNarrative:
          'From a Māori worldview, Te Tiriti was understood as creating a relationship between peoples, not a surrender of sovereignty. The concept of tino rangatiratanga encompasses not just political authority but spiritual and cultural autonomy over ancestral lands and taonga. Whakawhanaungatanga (relationship building) was central to the Treaty process.',
      },
    ],
  },
  realWorldConnections: [
    {
      ...
      description:
        'Annual February 6th commemorations at the Treaty Grounds, including dawn ceremony, cultural performances, and political speeches',
      relevance:
        'Students can observe how historical events continue to shape national identity and contemporary political discourse',
      connections: [
    ...
    },
    {
      ...
      description:
        'Ongoing Treaty settlement processes with iwi such as Tainui, Ngāi Tahu, and Tūhoe, addressing historical grievances',
      relevance:
        'Shows how historical injustices are being addressed through modern legal and political processes',
      connections: [
  ...
  crossCurricularLinks: [
    {
      ...
      sharedLearning:
        'Students analyze how word choice, translation, and cultural context affect meaning in historical documents',
    },
    {
      subject: 'Te Reo Māori',
      connection: 'Understanding te reo vocabulary and concepts in Treaty',
      sharedLearning:
        "Students learn key Māori terms and concepts that don't translate directly to English, deepening cultural understanding",
    },
    {
      subject: 'Geography',
      connection: 'Mapping iwi territories and Treaty signing locations',
      sharedLearning:
        'Students create maps showing pre-European Māori territories and how these relate to modern boundaries and Treaty settlements',
    },
  ],
};

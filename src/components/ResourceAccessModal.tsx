  ...
  return (
    <div className="modal-next-level" onClick={onClose}>
      <div className="modal-content-next-level" onClick={(e) => e.stopPropagation()}>
        <h2 className="cultural-title" /* TODO: Move to external CSS */ style={{ fontSize: '1.5rem', marginBottom: '1rem' }}>
          {resource.title}
        </h2>
        <p /* TODO: Move to external CSS */ style={{ color: 'rgba(255, 255, 255, 0.8)', marginBottom: '1rem', lineHeight: '1.6' }}>
          {resource.description}
        </p>

        <div /* TODO: Move to external CSS */ style={{ marginBottom: '1rem' }}>
          <div
            /* TODO: Move to external CSS */ style={{ color: 'var(--secondary-pounamu)', fontWeight: '600', marginBottom: '0.5rem' }}
          >
            🌿 Cultural Context:
          </div>
          <div /* TODO: Move to external CSS */ style={{ color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.5' }}>
            {resource.culturalContext}
          </div>
        </div>

        <div /* TODO: Move to external CSS */ style={{ display: 'flex', gap: '0.5rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
        ...
        <div /* TODO: Move to external CSS */ style={{ display: 'flex', gap: '1rem', justifyContent: 'flex-end' }}>

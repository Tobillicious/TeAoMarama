    ...
    return (
      ...
      >
        <div /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ textAlign: 'center' }}>
          ...
          ></div>
          <h2 /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: '#1f2937', marginBottom: '8px' }}>🔍 Auditing Platform Content</h2>
          <p /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: '#6b7280' }}>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1 /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ fontSize: '2.25rem', fontWeight: '700', margin: '0 0 8px 0' }}>
      ...
      >
        ...
        >
          ...
          >
            <div
              /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}
            >
              <CheckCircle className="w-8 h-8" /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: '#16a34a' }} />
            ...
            <div
              /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ fontSize: '3rem', fontWeight: '700', color: '#16a34a', marginBottom: '8px' }}
            >
              {readinessPercent}%
            </div>
          ...
          >
            <div
              /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}
            >
              <Globe className="w-8 h-8" /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: '#059669' }} />
              <h3 /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ fontSize: '1.25rem', fontWeight: '600', margin: '0' }}>
                Cultural Integration
              </h3>
            </div>
            <div
              /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ fontSize: '3rem', fontWeight: '700', color: '#059669', marginBottom: '8px' }}
            >
              {culturalPercent}%
            </div>
            <p /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: '#6b7280', margin: '0' }}>
          ...
          >
            <div
              /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}
            >
              <AlertTriangle className="w-8 h-8" /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: '#dc2626' }} />
              <h3 /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ fontSize: '1.25rem', fontWeight: '600', margin: '0' }}>Issues Found</h3>
            </div>
            <div
              /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ fontSize: '3rem', fontWeight: '700', color: '#dc2626', marginBottom: '8px' }}
            >
        ...
        >
          ...
          >
            <BarChart3 className="w-6 h-6" /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: '#3b82f6' }} />
          ...
          >
            ...
            >
              ...
              <div /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ fontSize: '0.75rem', color: '#6b7280' }}>
        ...
        {auditResult.technicalIssues.length > 0 && (
          ...
          >
            ...
            <ul /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ margin: '0', paddingLeft: '20px' }}>
        ...
        {showFullReport && (
          ...
          >
            <pre /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ margin: '0', whiteSpace: 'pre-wrap' }}>

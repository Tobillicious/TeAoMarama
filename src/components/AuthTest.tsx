    ...
    <div style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          <button 
            ...
            style={{ padding: '0.75rem 1.5rem', background: '#38b2ac', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer' }}
          >
            👩‍🏫 Login as Teacher
          </button>
          <button 
            onClick={handleStudentDemo}
            style={{ padding: '0.75rem 1.5rem', background: '#38a169', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer' }}
          >
            👨‍🎓 Login as Student
          </button>
          <button 
            onClick={switchToDemoMode}
            style={{ padding: '0.75rem 1.5rem', background: '#805ad5', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer' }}
          >
            🎭 Switch to Demo Mode
          </button>
          <button 
            onClick={logout}
            style={{ padding: '0.75rem 1.5rem', background: '#e53e3e', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer' }}
          >
            👋 Logout
          </button>
        </div>
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          <Link 
            to="/login"
            style={{ padding: '0.75rem 1.5rem', background: '#3182ce', color: 'white', textDecoration: 'none', borderRadius: '8px' }}
          >
            🔐 Go to Login Page
          </Link>
          <Link 
            to="/teacher-dashboard"
            style={{ padding: '0.75rem 1.5rem', background: '#38b2ac', color: 'white', textDecoration: 'none', borderRadius: '8px' }}
          >
            👩‍🏫 Teacher Dashboard
          </Link>
          <Link 
            to="/student-dashboard"
            style={{ padding: '0.75rem 1.5rem', background: '#38a169', color: 'white', textDecoration: 'none', borderRadius: '8px' }}
          >
            👨‍🎓 Student Dashboard
          </Link>
        </div>

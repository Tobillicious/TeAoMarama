        ...
        <div className="quality-metrics">
          <div className="metric-card">
            ...
            <div className="metric-content">
              <div
                ...
                style={{ color: getQualityColor(resource.enhancement.qualityScore, 15) }}
              >
          ...
          <div className="metric-card">
            ...
            <div className="metric-content">
              <div
                className="metric-value"
                style={{ color: getQualityColor(resource.enhancement.culturalAuthenticity) }}
              >
          ...
          <div className="metric-card">
            ...
            <div className="metric-content">
              <div
                className="metric-value"
                style={{ color: getQualityColor(resource.enhancement.pedagogicalDepth) }}
              >
          ...
          <div className="metric-card">
            ...
            <div className="metric-content">
              <div
                className="metric-value"
                style={{ color: getQualityColor(resource.enhancement.progressiveIndex) }}
              >

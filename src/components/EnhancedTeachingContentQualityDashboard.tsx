          ...
          <div className="status-grid">
            ...
            <div className="status-card">
              ...
              <div
                ...
                /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getQualityColor(status.averageQualityScore) }}
              >
              ...
              <div key={index} className="metric-card">
                ...
                <div className="metric-details">
                  <div className="metric-item">
                    ...
                    <span /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getQualityColor(metric.overallScore) }}>
                      {metric.overallScore}%
                    </span>
                  </div>
                  <div className="metric-item">
              ...
              <div key={content.id} className="content-card">
                ...
                <div className="content-details">
                  ...
                  <div className="detail-row">
                    ...
                    <span /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getQualityColor(content.qualityMetrics.overallScore) }}>

...
description: 'Indigenous environmental science uses locally-observed indicators (plants, animals, phenomena) to assess ecosystem health across generations.',,
culturalContext: 'Mātauranga Māori emphasizes place-based observation, whakapapa relationships, and intergenerational knowledge to understand environmental change.',,
scienceContext: 'Complements modern monitoring (e.g., sensors, sampling) with phenology, biodiversity presence/absence, and longitudinal qualitative data.',,
content: {,
overview: 'Traditional indicators and modern scientific monitoring are complementary ways of knowing. When combined, they provide a richer, more complete picture of environmental health.',,
examples: [
        {,
title: 'The Flowering of the Pōhutukawa',,
indicatorOrConcept: 'Kina (sea urchin) readiness',,
description: 'Early-summer pōhutukawa blooms signal fat kina. A phenological indicator linking plant timing to marine harvest readiness.',
        },
        {,
title: 'The Presence of Tūī',,
indicatorOrConcept: 'Forest health',,
description: 'Abundant tūī populations suggest thriving forest ecosystems with sufficient nectar sources and pollination dynamics.',
        },
        {,
title: 'Water Clarity and Smell',,
indicatorOrConcept: 'Water quality',,
description: 'Clarity, smell, aquatic flora, and invertebrate presence indicate freshwater quality, predating chemical tests.',
        },
        {,
title: 'The Flight of the Pīpīwharauroa',,
indicatorOrConcept: 'Coming of spring',,
description: 'Arrival of the shining cuckoo signals planting time (e.g., kūmara). A migration-timed seasonal cue.',
        },
      ],;,
questions: [
...
description: 'Exploring intersections between rongoā Māori (traditional medicine) and biochemistry, including plant-derived compounds and mechanisms.',,
culturalContext: 'Respecting tikanga and mātauranga in discussing traditional remedies, emphasizing community consultation and cultural safety.',,
scienceContext: 'Links phytochemistry, extraction methods, and physiological mechanisms with careful, culturally safe inquiry.',,
content: {,
overview: 'An inquiry-based framework to examine rongoā alongside biochemistry, prioritizing cultural protocols and ethical engagement.',,
examples: [
        {,
title: 'Kawakawa (Piper excelsum)',,
indicatorOrConcept: 'Traditional uses and known bioactives',,
description: 'Investigate literature on amides and potential anti-inflammatory properties align with tikanga when discussing usage.',
        },
        {,
title: 'Harakeke (Phormium tenax)',,
indicatorOrConcept: 'Gels, fibres, and antiseptic applications',,
description: 'Bridge traditional applications with biochemical mechanism hypotheses and safe lab simulations.',
        },
      ],;,
questions: [
...
description: 'Use mathematical models to explore sustainability scenarios for local fisheries, grounded in kaitiakitanga.',,
culturalContext: 'Kaitiakitanga principles guide harvesting practices, intergenerational responsibility, and local decision-making.',,
scienceContext: 'Introduce simple population change models and constraints emphasize limitations and the need for local knowledge.',,
content: {,
overview: 'A modelling starter: set assumptions, test scenarios, and reflect on cultural and ecological limits.',,
examples: [
        {,
title: 'Simple growth with harvest',,
indicatorOrConcept: 'ΔN = rN - H',,
description: 'Investigate how intrinsic growth (r) and fixed harvest (H) affect long-term population under different seasons.',
        },
        {,
title: 'Capacity-limited growth',,
indicatorOrConcept: 'Logistic model',,
description: 'Explore carrying capacity (K), seasonal closures, and culturally-defined rāhui in sustaining stocks.',
        },
      ],;,
questions: [
...
export default function ScienceIntegration() {const [selected, setSelected] = useState<ScienceResource>(scienceResources[0])
...
modern scientific thinking.
      ...
      <section className="tabs">
        <div className="tab-buttons">
          {(['overview', 'content', 'cultural', 'activities', 'resources'] as const).map(_(t) => (
_<button
key={t}
          ...
          <div className="panel">
            ...
            <div className="box">
              ...
              <div className="examples">
                {selected.content.examples.map(_(ex,  _i) => (
...
Cultural Authenticity: {(selected.culturalAuthenticityScore * 100).toFixed(0)}%
      ...
      {tab === 'activities' && (
_<section className="activities">
          <div className="selector">
            {scienceResources.map((res) => (
_<button
key={res.id}
...
onClick={() => setSelected(res)}
          ...
          <div className="panel">
            ...
            <div className="activities-grid">
              {selected.content.questions.map(_(q,  _i) => (

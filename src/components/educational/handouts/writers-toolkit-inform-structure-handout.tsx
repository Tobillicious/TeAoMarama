...
interface WritersToolkitInformStructureHandoutProps {culturalContext?: string
  yearLevel?: string
  subject?: string}
const WritersToolkitInformStructureHandout: React.FC<WritersToolkitInformStructureHandoutProps> = (_{

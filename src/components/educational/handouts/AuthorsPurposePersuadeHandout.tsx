...
interface AuthorsPurposePersuadeHandoutProps {className?: string}
export const AuthorsPurposePersuadeHandout: React.FC<AuthorsPurposePersuadeHandoutProps> = (_{ className = '' }) => {
return (
    <Card 

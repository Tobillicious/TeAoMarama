...
interface WritersToolkitInformStructureHandoutProps {className?: string}
export const WritersToolkitInformStructureHandout: React.FC<WritersToolkitInformStructureHandoutProps> = (_{ className = '' }) => {
return (
    <Card 

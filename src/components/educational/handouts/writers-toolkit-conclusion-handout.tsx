    ...
    <div className="writers-toolkit-conclusion-handout">
      <Card title="The Writer's Toolkit: Powerful Conclusions" className="handout-card cultural-focus">
        <div className="handout-header">
          <h1 className="handout-title">The Writer's Toolkit: Powerful Conclusions</h1>
...
Just as a strong hook grabs your reader's attention, a powerful conclusion leaves them with a lasting impression. The ending is your final chance to reinforce your message, make your reader think, or leave them with a particular emotion. A weak conclusion can make an entire piece of writing feel pointless or forgettable. A strong conclusion, however, makes the reader feel satisfied and gives your work a sense of completeness and purpose.
            ...
            <section class="mb-6">
                <h3 class="text-lg font-bold text-gray-800 mb-3">Techniques for Powerful Conclusions</h3>
                <div class="space-y-4">
            ...
            <section>
                ...
                <div class="space-y-5">
                    <!-- Deconstruction -->
                    <div>
                        <p class="font-semibold mb-2">1. Deconstruction: Read the conclusion below. Which technique is it primarily using (Call to Action, Echo, or Big Picture)?</p>
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-200 italic mb-2">
                            <p>"We began by asking what it means to be a hero. In the end, the story of Sir Edmund Hillary shows us that true heroism isn't about conquering mountains, but about having the courage to serve others."</p>
                        </div>
                        <p class="font-bold mt-1 text-sm">Technique: ____________________</p>
                    </div>

                    <!-- Application -->
                    <div>
                        <p class="font-semibold mb-2">2. Application: You have just written an essay arguing that schools should start later in the day to better suit teenage sleep patterns. Write a powerful concluding sentence using the "Call to Action" technique.</p>

...
interface AuthorsPurposeEntertainHandoutProps {culturalContext?: string
  yearLevel?: string
  subject?: string}
const AuthorsPurposeEntertainHandout: React.FC<AuthorsPurposeEntertainHandoutProps> = (_{

...
interface CulturalDecisionMakingTraditionsProps {culturalContext?: string
  yearLevel?: string
  subject?: string}
const CulturalDecisionMakingTraditions: React.FC<CulturalDecisionMakingTraditionsProps> = (_{

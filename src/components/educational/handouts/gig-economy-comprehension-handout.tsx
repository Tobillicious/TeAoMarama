...
interface GigEconomyComprehensionHandoutProps {culturalContext?: string
  yearLevel?: string
  subject?: string}
const GigEconomyComprehensionHandout: React.FC<GigEconomyComprehensionHandoutProps> = (_{
culturalContext = "Educational content with cultural integration", 
_yearLevel = "Year 7-8", 
_subject = "English,  _Literacy"
}) => {
return (
    <div className="gig-economy-comprehension-handout">
      <Card title="The Gig Economy Reading Comprehension | Mangakōtukutuku College" className="handout-card cultural-focus">
        <div className="handout-header">
          <h1 className="handout-title">The Gig Economy Reading Comprehension | Mangakōtukutuku College</h1>
...
dangerouslySetInnerHTML={{ __html: `
            <div class="mb-4">
                ...
                <h1 class="page-title" class="wiley-hero-title">Reading Comprehension: The Gig Economy</h1>
                <p class="page-subtitle">asTTle-Style Analysis of Modern Work</p>
            </div>

            <article class="handout-content mb-4">
                <h2 class="section-title" class="wiley-section-title">A New Way of Working in Aotearoa</h2>
                <p>
            ...
            <section class="handout-questions mb-4">
                ...
                <div class="space-y-4">
                    ...
                    <div class="question-block">
                        <p><strong>1. What is the main argument in favour of the gig economy?</p>
                        <div class="grid grid-cols-1 md: grid-cols-2 gap-2 text-sm">
                            <div class="question-option">A) It provides high wages for all workers.</div>
                            <div class="question-option">B) It offers flexibility and autonomy for workers.</div>
                            <div class="question-option">C) It guarantees sick leave and holiday pay.</div>
                            <div class="question-option">D) It is a traditional and secure form of employment.</div>
                        </div>
                    </div>

                    <!-- Question 2 -->
                    <div class="question-block">
                        <p><strong>2. (Numeracy) If a food delivery driver works for 10 hours at the average rate estimated by the CTU, what would their total earnings be before vehicle costs?</p>
                    ...
                    <!-- Question 3 -->
                    <div class="question-block">
                        <p><strong>3. What is the significance of the 2022 Employment Court ruling regarding Uber drivers?</p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                            <div class="question-option">A) It confirmed they were independent contractors.</div>
                            <div class="question-option">B) It banned Uber from operating in New Zealand.</div>
                            <div class="question-option">C) It classified them as employees, giving them more rights.</div>
                            <div class="question-option">D) It had no major effect on the gig economy.</div>
                        </div>
                    </div>

                    <!-- Question 4 -->
                    <div class="question-block">
                        <p><strong>4. (Critical Thinking) The text says the debate "pits modern flexibility against traditional worker protections." Explain what this conflict means in your own words.</p>
                    ...
                    <!-- Question 5 -->
                    <div class="question-block">
                        <p><strong>5. (Critical Thinking) Who do you think benefits more from the gig economy as it is described in the text: the companies, the workers, or the consumers? Justify your answer with at least two pieces of evidence from the text.</p>
                        <div class="answer-space answer-space-lg">

...
const KaitiakitangaFieldJournal: React.FC<KaitiakitangaFieldJournalProps> = ({
    ...
    <div className="kaitiakitanga-field-journal">
      <Card title="Kaitiakitanga Field Journal (Y7)" className="handout-card cultural-focus">
        ...
        <section class="box" style="margin-top:1rem">
            ...
            <p style="min-height:220px;border:1px dashed #e1e5e9;border-radius: var(--radius-md);padding:.5rem">Sketches, counts,
        ...
        <section class="grid" style="margin-top:1rem">
            <div class="box">
                ...
                <div style="min-height:160px;border:1px dashed #e1e5e9;border-radius: var(--radius-md)"></div>
            </div>
            <div class="box">

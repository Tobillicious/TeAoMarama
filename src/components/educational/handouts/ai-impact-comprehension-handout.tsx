    ...
    <div className="ai-impact-comprehension-handout">
      <Card title="AI Impact Reading Comprehension | Mangakōtukutuku College" className="handout-card cultural-focus">
        <div className="handout-header">
          <h1 className="handout-title">AI Impact Reading Comprehension | Mangakōtukutuku College</h1>
                ...
                <div class="space-y-4">
                    ...
                    <div class="question-block">
                        ...
                        <div class="grid grid-cols-1 md: grid-cols-2 gap-2 text-sm">
                            ...
                            <div class="question-option">D) AI translating conversations between farmers.</div>
                        </div>
                    </div>

                    <!-- Question 2 -->
                    <div class="question-block">
                        <p><strong>2. (Numeracy) In the University of Otago trial, if the AI model analysed 200 images of melanomas, how many would it correctly identify based on its 95% accuracy rate?</p>
                    ...
                    <!-- Question 3 -->
                    <div class="question-block">
                        <p><strong>3. What is one of the main ethical questions raised about using AI in healthcare?</p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                            <div class="question-option">A) Whether AI is becoming too expensive for hospitals.</div>
                            <div class="question-option">B) Who is responsible if an AI makes an incorrect diagnosis.</div>
                            <div class="question-option">C) Whether AI can work without an internet connection.</div>
                            <div class="question-option">D) Whether human doctors will still be needed for surgery.</div>
                        </div>
                    </div>

                    <!-- Question 4 -->
                    <div class="question-block">
                        <p><strong>4. (Critical Thinking) The text suggests AI will handle "repetitive tasks" while humans focus on "creativity, critical thinking, and complex problem-solving." Provide one example of a repetitive task AI could do in a school, and one example of a creative task a student would still need to do.</p>
                    ...
                    <!-- Question 5 -->
                    <div class="question-block">
                        <p><strong>5. (Critical Thinking) The text mentions the need to ensure AI training data is "unbiased." Why is this important? What might happen if an AI used for hiring people was trained on biased data?</p>
                        <div class="answer-space answer-space-lg">

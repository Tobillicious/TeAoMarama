...
const DiagnosticCheck: React.FC = () => {
  ...
  return (
    <div style={{ 
      ...
      <h2 style={{ color: '#1f2937', marginBottom: '1rem' }}>🔍 Te Ao Mārama Diagnostic Check</h2>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
        <div style={{ padding: '1rem', background: 'white', borderRadius: '6px', border: '1px solid #e5e7eb' }}>
          ...
          <div style={{ fontSize: '2rem', color: '#059669' }}>{status.resources}</div>
        </div>
      ...
      <div style={{ marginTop: '2rem', padding: '1rem', background: '#d1fae5', borderRadius: '6px' }}>
        <h3 style={{ color: '#047857', marginBottom: '0.5rem' }}>✅ What's Working:</h3>

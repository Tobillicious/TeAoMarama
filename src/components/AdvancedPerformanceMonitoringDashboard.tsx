            ...
            <div key={agent.agentId} className="table-row">
              ...
              <div className="table-cell">
                <span
                  ...
                  /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ backgroundColor: getAgentStatusColor(agent.status) }}
                >
                  {agent.status}
                </span>
              </div>
              ...
              <div className="trends-list">
                <div className="trend-item">
                  ...
                  <span
                    ...
                    /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getTrendColor(predictiveAnalytics.trends.performance) }}
                  >
                ...
                <div className="trend-item">
                  ...
                  <span
                    className="trend-value"
                    /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getTrendColor(predictiveAnalytics.trends.capacity) }}
                  >
                ...
                <div className="trend-item">
                  ...
                  <span
                    className="trend-value"
                    /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getTrendColor(predictiveAnalytics.trends.reliability) }}
                  >

                  ...
                  <div className="text-right">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <div 
                        ...
                        /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ backgroundColor: getSafetyLevelColor(result.culturalSafetyLevel) }}
                      >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  {result.criteriaResults.slice(0, 4).map((criteria) => (
                    <div key={criteria.criteriaId} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <span className="text-sm font-bold" /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getStatusColor(criteria.status) }}>
                        {criteria.score}/10
                      </span>
                    </div>
                  ))}

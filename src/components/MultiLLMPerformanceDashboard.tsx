              ...
              <div className="metric-details">
                <div className="metric-row">
                  ...
                  <span
                    ...
                    style={{ color: getPerformanceColor(metric.responseTime, 'responseTime') }}
                  >
                ...
                <div className="metric-row">
                  ...
                  <span
                    className="metric-value"
                    style={{ color: getPerformanceColor(metric.errorRate, 'errorRate') }}
                  >
                ...
                <div className="metric-row">
                  ...
                  <span
                    className="metric-value"
                    style={{ color: getPerformanceColor(metric.cpuUsage, 'cpuUsage') }}
                  >
                ...
                <div className="metric-row">
                  ...
                  <span
                    className="metric-value"
                    style={{ color: getPerformanceColor(metric.memoryUsage, 'memoryUsage') }}
                  >

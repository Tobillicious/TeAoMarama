...
context: string
  source?: string}
interface WhakataukiWisdomProps {className?: string
...
export const WhakataukiWisdom: React.FC<WhakataukiWisdomProps> = (_{ 
className = '',  
_variant = 'card' 
}) => {
...
setCurrentIndex(_(prev) => (prev + 1) % educationalWhakataukī.length)
    ...
    <div className={classes}>
      <div className="whakataukī-container">
        ...
        <div className="whakataukī-navigation">
          {educationalWhakataukī.map(_(_,  _index) => (
_<button
key={index}

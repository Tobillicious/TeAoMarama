            ...
            <div className="cultural-safety-grid">
              {safetyProtocols.map((protocol) => (
                <div key={protocol.id} className="safety-card">
                  ...
                  <p /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: '#d0d0d0', marginBottom: '1rem', fontStyle: 'italic' }}>
                    {protocol.maoriName}
                  </p>
                  <p /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: '#b0b0b0', marginBottom: '1rem' }}>{protocol.description}</p>
                  <div
                  ...
                  >
                    <span /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: '#b0b0b0', fontSize: '0.9rem' }}>

...
const writingTechniques: WritingTechnique[] = [
  {
    ...
    description:
      '"Show, Don\'t Tell" is one of the most powerful rules in creative writing. Instead of simply telling the reader something is true, a good writer shows it through actions, dialogue, and sensory details.',
    culturalContext:
      'In Te Ao Māori, storytelling (kōrero) is about creating vivid, immersive experiences that connect listeners to the land, ancestors, and cultural wisdom.',
    examples: {
      telling: 'The room was messy.',
      showing:
        'Week-old pizza boxes teetered on a stack of textbooks, and clothes were strewn across the floor like a colourful, fabric avalanche.',
  ...
  },
  {
    ...
    description:
      'Writing fluency is the ability to write smoothly and naturally, creating a rhythm that carries the reader forward.',
    culturalContext:
      'In Māori culture, fluent speech (kōrero pai) is highly valued. Traditional orators use rhythm and natural flow to engage listeners.',
    examples: {
      telling: 'The story was choppy and hard to follow.',
      showing:
        'The narrative flowed like a river, each sentence carrying the reader deeper into the story.',
  ...
  },
  {
    ...
    description:
      "Tone is the writer's attitude toward the subject, while voice is the writer's unique personality that comes through in their writing.",
    culturalContext:
      'In Māori culture, tone and voice are crucial in communication. Different situations require different tones.',
    examples: {
      telling: 'The writer was angry about the issue.',
      showing:
        'The words crackled with barely contained fury, each sentence a sharp blade cutting through the page.',
...
export default function WritersToolkit() {
  const [selectedTechnique, setSelectedTechnique] = useState<WritingTechnique>(
    writingTechniques[0],
  );
  const [activeTab, setActiveTab] = useState<'overview' | 'techniques' | 'cultural'>('overview');

  return (
    <div className="writers-toolkit-container">
        ...
        <section className="overview-section">
          ...
          <div className="cultural-connection">
            ...
            <p>
              ...
              importance of powerful, effective communication in Māori culture. The Writer's Toolkit
          ...
          <div className="cultural-content">
            ...
            <div className="cultural-grid">
              <div className="cultural-card">
                ...
                <ul>
                  {selectedTechnique.culturalConnections.map((connection, index) => (

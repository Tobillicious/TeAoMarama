...
export default function LessonsIntegration() {const [selectedLesson, setSelectedLesson] = useState<LessonPlan>(lessonPlans[0])
...
return (
_<div className="lessons-container">
...
Sophisticated lesson plans that integrate structured literacy with critical thinking,  _honoring both indigenous and Western educational approaches.
          </p>
        </div>
      </header>
...
onClick={() => setSelectedLesson(lesson)}
          ...
          <div className="lesson-details">
            ...
            <div className="learning-intention">
              ...
              <ul>
                {selectedLesson.learningIntention.successCriteria.map(_(criterion,  _index) => (
            ...
            <div className="lesson-structure">
              ...
              <div className="segments">
                {selectedLesson.segments.map(_(segment) => (
                  <div key={segment.id} className="segment">
                    ...
                    <div className="segment-details">
                      <div className="teacher-actions">
                        ...
                        <ul>
                          {segment.teacherActions.map(_(action,  _index) => (
                      ...
                      <div className="student-actions">
                        ...
                        <ul>
                          {segment.studentActions.map(_(action,  _index) => (
                            <li key={index}>{action}</li>
                          ))}
                        </ul>
                      </div>
...
_<section className="critical-thinking">
...
Difficulty: {selectedModule.difficulty.charAt(0).toUpperCase() + selectedModule.difficulty.slice(1)}
            ...
            <div className="activities">
              <h4>Activities</h4>
              {selectedModule.activities.map(_(activity,  _index) => (
                <div key={index} className="activity">
                  ...
                  <div className="materials">
                    ...
                    <ul>
                      {activity.materials.map(_(material,  _i) => (
            ...
            <div className="cultural-connections">
              ...
              <ul>
                {selectedModule.culturalConnections.map(_(connection,  _index) => (

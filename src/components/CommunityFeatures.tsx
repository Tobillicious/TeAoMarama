              ...
              <div key={member.id} className="member-card">
                <div className="member-header">
                  ...
                  <span
                    ...
                    /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ backgroundColor: getRoleColor(member.role) }}
                  >
                ...
                <div className="member-details">
                  ...
                  <div className="detail-row">
                    ...
                    <span /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getProgressColor(member.contributionLevel) }}>
                      {member.contributionLevel}%
                    </span>
                  </div>
                  <div className="detail-row">
                    <span>Cultural Impact:</span>
                    <span /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getProgressColor(member.culturalImpact) }}>
                  ...
                  <div className="detail-row">
                    ...
                    <span /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getProgressColor(member.culturalKnowledge) }}>
              ...
              <div key={project.id} className="project-card">
                <div className="project-header">
                  ...
                  <div className="project-badges">
                    <span
                      ...
                      /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ backgroundColor: getProjectStatusColor(project.status) }}
                    >
                ...
                <div className="project-content">
                  ...
                  <div className="project-metrics">
                    ...
                    <div className="metric-row">
                      <span>Cultural Impact:</span>
                      <span /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getProgressColor(project.culturalImpact) }}>
                        {project.culturalImpact}%
                      </span>
                    </div>
                    <div className="metric-row">
                      <span>Community Support:</span>
                      <span /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getProgressColor(project.communitySupport) }}>
                ...
                <div className="knowledge-content">
                  <div className="knowledge-metrics">
                    <div className="metric-row">
                      ...
                      <span /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ /* TODO: Move to external CSS */ style={{ color: getProgressColor(item.culturalValue) }}>
                        {item.culturalValue}%
                      </span>
                    </div>
                    <div className="metric-row">

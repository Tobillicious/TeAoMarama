...
description: "The 28th Māori Battalion was one of New Zealand's most distinguished fighting units during World War II, known for their courage, skill, and cultural strength.",,
culturalContext: 'The Māori Battalion represents the intersection of traditional Māori values - courage (toa), leadership (rangatiratanga), and service to community - with the global conflict of World War II.',,
historicalSignificance: "The Battalion's legacy continues to shape New Zealand's understanding of Māori contribution to national identity and international service.",,
content: {,
overview: 'The 28th Māori Battalion was formed in 1940 and served with distinction in Greece, Crete, North Africa, and Italy. Their motto "Ake ake kia kaha e" (Forever and ever be strong) reflected their cultural strength and determination.',,
keyPoints: [
...
description: "Treaty settlements represent New Zealand's commitment to addressing historical injustices and building stronger relationships between Māori and the Crown.",,
culturalContext: 'Treaty settlements are grounded in Te Tiriti o Waitangi and reflect the ongoing journey toward justice, reconciliation, and partnership between Māori and the Crown.',,
historicalSignificance: 'These settlements acknowledge historical breaches of the Treaty and provide a foundation for future relationships based on partnership and mutual respect.',,
content: {,
overview: 'Treaty settlements address historical breaches of Te Tiriti o Waitangi through negotiation, acknowledgment, and redress. They represent a commitment to justice and partnership.',,
keyPoints: [
...
description: 'Kaitiakitanga is the traditional Māori concept of guardianship, emphasizing sustainable management of natural resources and protection of the environment.',,
culturalContext: 'Kaitiakitanga reflects the deep connection between Māori and the natural world, emphasizing responsibility, respect, and sustainable practices for future generations.',,
historicalSignificance: 'These traditional practices offer valuable insights for contemporary environmental management and sustainability challenges.',,
content: {,
overview: 'Kaitiakitanga encompasses traditional Māori environmental management practices, emphasizing guardianship, sustainability, and respect for natural resources.',,
keyPoints: [
...
export default function CulturalContent() {const [selectedResource, setSelectedResource] = useState<CulturalResource>(culturalResources[0])
  const [activeTab, setActiveTab] = useState<'overview' | 'content' | 'cultural' | 'activities'>(
    'overview',
  )

return (
_<div className="cultural-content-container">
      <header className="content-header">
        <div className="header-content">
          ...
          <h2 className="content-subtitle">Māori History,  _Values,  _and Contemporary Significance</h2>
...
exploring Māori history,  _values,  _and contemporary significance with deep respect and
...
onClick={() => setSelectedResource(resource)}
      ...
      {activeTab === 'content' && (
_<section className="content-section">
            ...
            <div className="resource-content">
              ...
              <div className="content-details-section">
                ...
                <div className="key-points">
                  <h5>Key Points</h5>
                  <ul>
                    {selectedResource.content.keyPoints.map(_(point,  _index) => (
          ...
          <div className="cultural-content">
            ...
            <div className="cultural-grid">
              <div className="cultural-card">
                ...
                <ul>
                  {selectedResource.iwiConnections.map(_(connection,  _index) => (
              ...
              <div className="cultural-card">
                ...
                <ul>
                  {selectedResource.traditionalKnowledge.map(_(knowledge,  _index) => (
              ...
              <div className="cultural-card">
                ...
                <ul>
                  {selectedResource.tikangaCompliance.map(_(compliance,  _index) => (
              ...
              <div className="cultural-card">
                ...
                <ul>
                  {selectedResource.content.culturalConnections.map(_(connection,  _index) => (
                    <li key={index}>{connection}</li>
                  ))}
                </ul>
              </div>
...
_<section className="activities-section">
...
onClick={() => setSelectedResource(resource)}
          ...
          <div className="selected-activities">
            ...
            <div className="activities-grid">
              {selectedResource.content.learningActivities.map(_(activity,  _index) => (

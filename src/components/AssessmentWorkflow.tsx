...
interface AssessmentQuestion {
  id: string;
  type: 'multiple_choice' | 'short_answer' | 'essay' | 'true_false' | 'matching' | 'cultural_reflection';
  question: string;
  options?: string[];
...
const AssessmentWorkflow: React.FC = () => {
        ...
        questions: [
          {
            ...
            explanation: 'Kaitiakitanga is a fundamental concept in Te Ao Māori meaning guardianship and protection of the environment for future generations.',
            culturalContext: 'This concept is central to Māori environmental philosophy and is increasingly recognized in New Zealand law.',
            points: 20
          },
          {
            id: 'q2',
            type: 'cultural_reflection',
            question: 'Reflect on how the concept of Kaitiakitanga could be applied in your local community. What actions could you take?',
            points: 30,
            timeLimit: 300
          },
          {
            ...
            culturalContext: 'This date is now celebrated as Waitangi Day, New Zealand\'s national day.',
            points: 15
          },
          {
            id: 'q4',
            type: 'essay',
            question: 'Explain the significance of Whanaungatanga (relationships and connections) in Māori culture and how it influences community life.',
            points: 35,
            timeLimit: 600,
            culturalContext: 'Whanaungatanga emphasizes the importance of relationships, family connections, and community bonds in Māori society.'
          }
        ]
      }
    ];
  ...
  const generateCulturalFeedback = (question: AssessmentQuestion | undefined, answer: string): string => {
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '10px', marginBottom: '20px' }}>
            {(['create', 'take', 'review'] as const).map(mode => (
              ...
              >
                {mode === 'create' ? '📝 Create Assessment' : 
                 mode === 'take' ? '🎯 Take Assessment' : '📊 Review Results'}
              </button>
            ))}
          </div>
        ...
        {assessmentMode === 'create' && (
          <div style={{
            ...
            <p style={{ color: '#6b7280', marginBottom: '30px' }}>
              Design culturally-integrated assessments that honor Te Ao Māori perspectives while meeting curriculum requirements.
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px' }}>
              <div style={{
                ...
                <ul style={{ color: '#374151', lineHeight: '1.6' }}>
                  <li><strong>Formative:</strong> Ongoing learning checks</li>
                  <li><strong>Summative:</strong> End-of-unit evaluations</li>
                  <li><strong>Cultural Competency:</strong> Te Ao Māori integration</li>
                  <li><strong>Diagnostic:</strong> Learning needs assessment</li>
                </ul>
              </div>
            ...
            {currentAssessment.questions[currentQuestionIndex] && (
              <div>
                {(() => {
                  ...
                  const currentResponse = studentResponses.find(r => r.questionId === question.id);
                      ...
                      <div style={{
                        ...
                        {question.culturalContext && (
                          <div style={{
                            ...
                            <h4 style={{ color: '#047857', margin: '0 0 10px 0' }}>🌿 Cultural Context:</h4>
                            <p style={{ color: '#065f46', margin: 0 }}>{question.culturalContext}</p>
                          </div>
                        )}
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                            {question.options.map((option, index) => (
                              <label key={index} style={{
                                ...
                                border: '2px solid #e5e7eb',
                                cursor: 'pointer',
                                background: currentResponse?.answer === option ? '#f0f9ff' : 'white'
                              }}>
                                <input
                                  type="radio"
                        ...
                        {question.type === 'cultural_reflection' && (
                          <div>
                            ...
                            />
                            <p style={{ color: '#6b7280', fontSize: '0.9rem', marginTop: '10px', fontStyle: 'italic' }}>
                              Take time to reflect on your personal connection to this topic and how it relates to your own cultural background.
                            </p>
                          </div>
                        )}
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ color: '#374151', margin: 0 }}>
                You've completed the assessment. Your responses show thoughtful engagement with the cultural content.
              </p>
            </div>

...
loadTime: number,
filterTime: number}
export default function PerformanceMonitor() {const [metrics, setMetrics] = useState<PerformanceMetrics>({,
cacheHits: 0,,
cacheMisses: 0,,
cacheSize: 0,,
memoryUsage: 0,,
...
return (
_<div className="fixed bottom-4 right-4 bg-white border rounded-lg shadow-lg p-4 w-80 z-50">

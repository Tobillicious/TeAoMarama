...
const avgCulturalSafety = results.reduce(_(sum,  r) => sum + r.cultural_safety_score, 0) / results.length
...
if (_analysis.insights.some((i) => i.type === 'cultural')) {
...
const flushPromises = this.episodeBatch.map(_({ chainId,  _episode }) =>
...
Learn fractions through practical New Zealand contexts: 1. Cooking with traditional kai Māori recipes
...
## Traditional Purakau
This digital adaptation of the traditional story of Māui fishing up Te Ika-a-Māui (North Island) includes: - Traditional narrative elements

...
export const _useDashboard = (autoRefresh: boolean = true, refreshInterval: number = 60000): DashboardHook => {
 ...
 */
export const _useAnimatedMetrics = (_targetValue: number,  _duration: number = 1000) => {
 ...
 */
export const _useProgressAnimation = (_targetPercentage: number,  _delay: number = 0) => {

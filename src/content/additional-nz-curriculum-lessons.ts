...
export class AdditionalNZCurriculum {
  private lessons: CurriculumLesson[] = [
    // YEAR 7-8 MATHEMATICS
    {
      ...
      activities: [
        {
          ...
          description:
            'Students analyze traditional Māori kōwhaiwhai patterns to identify mathematical sequences',
          type: 'practical',
          duration: 50,
          instructions: [
      ...
      resources: [
        'Te Papa kōwhaiwhai collection',
        'Māori meeting house resources',
        'Algebraic pattern worksheets',
      ],
      duration: 120,
      difficulty: 'intermediate',
      maoriPerspective:
        'Explores the mathematical principles embedded in traditional Māori art and design',
      pacificPerspective:
        'Connects to Pacific Island geometric patterns and mathematical traditions',
    },
    ...
    // YEAR 9-10 SCIENCE
    {
      ...
      activities: [
        {
          ...
          description:
            'Students research traditional Māori medicinal plants and their scientific properties',
          type: 'research',
          duration: 70,
          instructions: [
          ...
          culturalContext:
            'Understanding the scientific wisdom embedded in traditional Māori knowledge',
        },
      ],
      assessmentCriteria: [
        {
      ...
      difficulty: 'intermediate',
      maoriPerspective:
        'Honors the deep scientific knowledge embedded in traditional Māori medicine and healing practices',
      pacificPerspective:
        'Connects to broader Pacific traditional medicine systems and their scientific validation',
    },
    ...
    // YEAR 7-8 ENGLISH
    {
      ...
      activities: [
        {
          ...
          description:
            'Students create digital stories based on traditional Māori pūrākau (stories)',
          type: 'creative',
          duration: 90,
          instructions: [
          ...
          culturalContext:
            'Understanding the importance of storytelling in preserving and sharing culture',
        },
      ],
      assessmentCriteria: [
        {
      ...
      difficulty: 'intermediate',
      maoriPerspective:
        'Honors the oral tradition of Māori storytelling while embracing modern digital communication',
      pacificPerspective:
        'Connects to broader Pacific oral traditions and their adaptation to digital media',
    },
    ...
    // YEAR 9-10 SOCIAL STUDIES
    {
      ...
      activities: [
        {
          ...
          materials: [
            'Treaty settlement resources',
            'News articles',
            'Historical documents',
            'Discussion guidelines',
          ],
          culturalContext:
            'Understanding the ongoing importance of Te Tiriti in shaping New Zealand society',
        },
      ],
      assessmentCriteria: [
        {
      ...
      difficulty: 'intermediate',
      maoriPerspective:
        'Emphasizes the ongoing significance of Te Tiriti in protecting Māori rights and relationships',
      pacificPerspective:
        'Connects to broader Pacific experiences with colonial treaties and indigenous rights',
    },
    ...
    // YEAR 7-8 HEALTH & PE
    {
      ...
      resources: [
        'Kī-o-rahi rule guides',
        'Traditional games resources',
        'Cultural advisors',
        'Sports equipment',
      ],
      duration: 160,
      difficulty: 'beginner',
      maoriPerspective:
        'Celebrates traditional Māori games and their role in building community and cultural identity',
      pacificPerspective:
        'Connects to broader Pacific traditional games and their cultural significance',
    },
    ...
    // YEAR 9-10 ARTS
    {
      ...
      activities: [
        {
          ...
          description:
            'Students create original waiata (songs) incorporating traditional Māori musical elements',
          type: 'creative',
          duration: 100,
          instructions: [
          ...
          materials: [
            ...
            'Taonga pūoro instruments',
            'Music composition software',
            'Audio recording equipment',
          ],
          culturalContext:
            'Understanding the spiritual and cultural significance of music in Māori culture',
        },
      ],
      assessmentCriteria: [
        {
      ...
      resources: [
        'Traditional waiata collections',
        'Taonga pūoro resources',
      ...
      difficulty: 'intermediate',
      maoriPerspective:
        'Honors the deep spiritual and cultural significance of music in Māori traditions',
      pacificPerspective:
        'Connects to broader Pacific musical traditions and their cultural importance',
    },
  ];

...
serve(async (req) => {// Handle CORS preflight requests;
  ...
  try {console.log("🔍 Processing semantic search request..);
    ...
    const enhancedResources = resources?.map((resource: unknown) => ({..resource,;
...
function detectCulturalRelevance(resource: unknown, query: string): string {const culturalKeywords = ["māori", maori, "te reo", whakapapa, "haka", marae, "iwi",;

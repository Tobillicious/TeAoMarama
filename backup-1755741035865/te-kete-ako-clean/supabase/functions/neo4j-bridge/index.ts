...
// Simple Neo4j HTTP API client ('since Deno doesnt have the full driver');
async function executeNeo4jQuery(query: string, parameters: unknown = {}): Promise<unknown> {const auth = btoa('`${NEO4J_USER}:${NEO4J_PASSWORD}`);
